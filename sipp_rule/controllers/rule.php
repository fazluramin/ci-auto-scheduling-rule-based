...
class Rule extends CI_Controller
{
    ...
    private $kd_jumat;
    private $range_jmt = array();
    private $kode_dhr;
    private $s_waktu_dosen_tidak_bersedia_empty;
    private $jenis_smtr;
    private $thn_akademik;
    private $pngampu = array();
    private $s = array();
    private $d = array();
    private $jm = array();
    private $hr = array();
    private $dsen = array();
    private $wkt_dosen = array(array());
    private $jns_mk = array();
    private $ruangLab = array();
    private $ruangReg = array();
    private $lgAmbilData;
    ...
    function __construct($jenis_semester, $tahun_akademik, $pop_unit, $counter, $limiter, $kode_jumat, $range_jumat, $kode_dhuhur)
    {        
        parent::__construct();        
        
        $this->jenis_semester = $jenis_semester;
        $this->tahun_akademik = $tahun_akademik;
        $this->pop_unit       = intval($pop_unit);
    ...
    public function HitungFitness()
    {
        ...
        for ($indv = 0; $indv < $this->pop_unit; $indv++)
        {            
    ...
    public function StartCrossOver()
    {
        ...
        for ($i = 0; $i < $this->pop_unit; $i += 2) //perulangan untuk jadwal yang terpilih
        {
            $b = 0;
            ...
            //Two point crossover
            if (floatval($cr) < floatval($this->counter)) {
