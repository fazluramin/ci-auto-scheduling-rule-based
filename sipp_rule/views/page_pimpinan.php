               ...
               <body class="">
                  ...
                  <div class="navbar">
                     <div class="navbar-inner">
                        <a class="brand" href="#"><span class="first">Penjadwalan</span> <span class="second">Matakuliah</span> 
                     	</a>
                     </div>
                  </div>
                  <div class="sidebar-nav" style="padding-top: 5px">
                     ...
                     <a href="<?php echo base_url();?>" class="nav-header"><i class="icon-th-list"></i>Beranda <?php echo ucfirst($this->session->userdata('level'));?></a>
                     ...
                     <ul id="content-menu" class="nav nav-list collapse in">                        
					  ...
					  <a class="nav-header" ><i class="icon-book"></i>Navigasi </a>
                     <ul id="content-menu" class="nav nav-list collapse in">                        
						<li><a href="<?php echo base_url();?>login/logout"><i class="icon-repeat"></i>Log Out</a></li>
					 </ul>	
                  </div>
